        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Ready to discuss your technology needs? Get in touch with our
              expert team to explore how we can help bring your ideas to life.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        <a
                          href="mailto:info@mbclaboratory.com"
                          className="hover:text-blue-600 transition-colors"
                        >
              ...
              <div>
                ...
                <div className="w-full h-64 bg-gray-200 rounded-lg border border-gray-300 flex items-center justify-center relative overflow-hidden">
                  <div className="text-center">
                    <svg
              ...
              <form className="space-y-6" action="#" method="POST">
                ...
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  <p className="text-sm text-gray-600">
                    ...
                    All messages are handled through a lightweight PHP or
                    Node.js backend for secure processing and delivery.
                  </p>
                </div>
              </form>
            </div>
